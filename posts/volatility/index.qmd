...
pg_plot <- plot_rolling_sd(pg_data, "PG", c(0, 0.0350), custom_colors, custom_alphas)
jpm_plot <- plot_rolling_sd(jpm_data, "JPM", c(0, 0.0550), custom_colors, custom_alphas)
nvda_plot <- plot_rolling_sd(nvda_data, "NVDA", c(0, 0.0750), custom_colors, custom_alphas)
...
plot_jpm <- plot_ewma_for_stock(jpm_data, "JPM", "daily.returns", lambda_list, 
                                custom_colors, custom_alphas, 0.080)
plot_pg <- plot_ewma_for_stock(pg_data, "PG", "daily.returns", lambda_list, 
                               custom_colors, custom_alphas, 0.0550)
plot_nvda <- plot_ewma_for_stock(nvda_data, "NVDA", "daily.returns", lambda_list, 
...
plot_jpm <- plot_histogram_with_normal(jpm_data, "JPM", "daily.returns")
plot_pg <- plot_histogram_with_normal(pg_data, "PG", "daily.returns")
plot_nvda <- plot_histogram_with_normal(nvda_data, "NVDA", "daily.returns")
